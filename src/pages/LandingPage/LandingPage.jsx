  ...
  return (
    <div className="bg-custom-gradient flex flex-col h-screen">
      <nav className="flex items-center md:space-x-72 p-4 flex-shrink-0">
        ...
        <div className="hidden md:flex items-center justify-center space-x-8 bg-custom-blue px-8 py-4 rounded-full text-custom-black shadow-md">
      ...
      <div className="flex-grow flex flex-col justify-center items-center text-center p-4">
        ...
        <div className="flex-col md:flex-row mt-6 w-full max-w-md">
          <input
            ...
            className="px-12 py-2 rounded-full text-sm bg-transparent border border-white text-white mb-2 md:mb-0 md:mr-4"
          />
      ...
      <footer className="py-6 text-center text-white flex-shrink-0">
        ...
        <div className="flex justify-center space-x-4 mt-2">
          <FaFacebook className="h-6 w-6 text-gray-600 rounded-full hover:text-blue-600 transition" />
          <FaLinkedin className="h-6 w-6 text-gray-600 rounded-full hover:text-blue-700 transition" />
          <FaTwitter className="h-6 w-6 text-gray-600 rounded-full hover:text-blue-500 transition" />
        </div>
      </footer>
    </div>
  );
